...
import mql.dominators.brico.service.SequenceGenerator;
...
//		accountService.saveUser(new User(sequenceGenerator.generateSequence(User.SEQUENCE_NAME), "said", "said1997"));
//		accountService.saveUser(new User(sequenceGenerator.generateSequence(User.SEQUENCE_NAME), "youness", "1989"));
